...
func NewCasbinAdapter(cfg *config.AppConfig) (*CasbinAdapter, error) {
...
func (pm *CasbinAdapter) AddPolicyForUser(user string, resource string, action string, effect string) error {
...
func (pm *CasbinAdapter) AddPoliciesForUser(userID string, policies [][]string) error {
...
func (pm *CasbinAdapter) GetFilteredPolicy(index int, userID string) ([][]string, error) {
...
func (pm *CasbinAdapter) HasPolicyForUser(userID string, resource string, action string, effect string) (bool, error) {
...
func (pm *CasbinAdapter) CanUserLogin(userID string) (bool, error) {
...
func (pm *CasbinAdapter) RemovePolicyForUser(user string, resource string, action string, effect string) error {
...
func (pm *CasbinAdapter) RemoveAllPoliciesForUser(user string) error {
...
func (pm *CasbinAdapter) AddMultiplePolicies(policies [][]string) error {
...
func (pm *CasbinAdapter) RemoveMultiplePolicies(policies [][]string) error {
...
func (pm *CasbinAdapter) CanUserPerformAction(user string, resource string, action string) (bool, error) {
...
func (pm *CasbinAdapter) ResetPolicies() {
	pm.e.ClearPolicy()
}

func (pm *CasbinAdapter) ReloadPolicies() error {
